...
parser.add_argument('--SW', default=1, type=int)
parser.add_argument('--SB', default=4, type=int)
...
#marker = mlines.Line2D([], [], color='red', marker='+', markersize=50, linewidth=5, markeredgewidth=5, label='Standard deviation')
