...
for i in range(len(Ns_Prior)):
    bnn = BNN([1, Ns_Prior[i], Ns_Prior[i], Ns_Prior[i], 1], Num_Q, [None, Sigma_W, Sigma_W, Sigma_W, None], [None, Sigma_B, Sigma_B, Sigma_B, None], 0.0, gp_mean, gp_cov, q_method)
